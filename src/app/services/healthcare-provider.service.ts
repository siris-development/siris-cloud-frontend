...
export class HealthcareProviderService {
  ...
  createHealthcareProvider(
    data: Omit<CreateHealthcareProviderRequest, 'tenantId'>
  ): Observable<HealthcareProviderResponse> {
    return this.http
      .post<HealthcareProviderResponse>(
  ...
  /**
   * Obtener todos los Proveedores de Servicios de Salud del tenant del usuario autenticado
   */
  ...
  getHealthcareProviderById(
    providerId: string
  ): Observable<HealthcareProvider> {
    return this.http
      .get<HealthcareProvider>(`${environment.baseUrl}/pt/${providerId}`, {
        headers: this.getHeaders(),
      })
      .pipe(
        catchError((error) => {
  ...
  updateHealthcareProvider(
    providerId: string,
    data: UpdateHealthcareProviderRequest
  ): Observable<HealthcareProviderResponse> {
    return this.http
      .patch<HealthcareProviderResponse>(
   ...
   */
  createHealthcareProviderConfig(
    data: CreateHealthcareProviderConfigRequest
  ): Observable<HealthcareProviderConfigResponse> {
    return this.http
      .post<HealthcareProviderConfigResponse>(
   ...
   */
  getHealthcareProviderConfigById(
    configId: string
  ): Observable<HealthcareProviderConfig> {
    return this.http
      .get<HealthcareProviderConfig>(
   ...
   */
  getHealthcareProviderConfigsByProvider(
    providerId: string
  ): Observable<HealthcareProviderConfig[]> {
    return this.http
      .get<HealthcareProviderConfig[]>(
   ...
   */
  updateHealthcareProviderConfig(
    configId: string,
    data: UpdateHealthcareProviderConfigRequest
  ): Observable<HealthcareProviderConfigResponse> {
    console.log('data', data);
    console.log('configId', configId);
    return this.http
      .patch<HealthcareProviderConfigResponse>(
   ...
   */
  deleteHealthcareProviderConfig(
    configId: string
